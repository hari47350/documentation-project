...
```text title="<a id="using-try-except-blocks"></a>3\.1 Using try\-except Blocks"
__Example:__
...
```text title="<a id="specific-exception-types"></a>3\.2 Specific Exception Types"
__Example:__
...
```text title="<a id="raising-exceptions"></a>3\.3 Raising Exceptions"
__Example:__
...
```text title="<a id="logging-errors"></a>3\.4 Logging Errors"
__Example:__
...
```text title="<a id="failing-gracefully"></a>3\.5 Failing Gracefully"
__Example:__
