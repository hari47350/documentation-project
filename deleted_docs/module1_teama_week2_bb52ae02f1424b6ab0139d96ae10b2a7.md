...
```python title="week2.md snippet 12"
def get\_db\(\):  
    return client\["mydb"\]  
```
...
```text title="week2.md snippet 16"
...
```text title="week2.md snippet 17"
...
```python title="week2.md snippet 18"
...
```text title="week2.md snippet 21"
...
```text title="week2.md snippet 22"
...
```text title="week2.md snippet 23"
...
```text title="week2.md snippet 24"
...
```text title="week2.md snippet 27"
...
\# Cleanup old backups  
```text title="week2.md snippet 28"
...
```text title="week2.md snippet 29"
...
```text title="week2.md snippet 30"
...
```python title="week2.md snippet 31"
...
```text title="week2.md snippet 32"
...
```text title="week2.md snippet 33"
db = get\_db\(\)  
...
NUM\_SEGMENTS = 10000  
```text title="week2.md snippet 34"
...
```text title="week2.md snippet 35"
...
```text title="week2.md snippet 36"
db = get\_db\(\)  
DOC = db\.raw\_documents\.find\_one\(\)  
DOC\_ID = str\(DOC\['\_id'\]\)  
```
...
NUM\_SEGMENTS = 10000  
```text title="week2.md snippet 37"
...
```text title="week2.md snippet 38"
...
```text title="week2.md snippet 39"
db = get\_db\(\)  
DOC = db\.raw\_documents\.find\_one\(\)  
DOC\_ID = str\(DOC\['\_id'\]\)  
```
TENANT\_ID = "t0"  
```text title="week2.md snippet 40"
query = \{"tenant\_id": TENANT\_ID, "doc\_id": DOC\_ID\}  
```
  
times = \[\]  
```text title="week2.md snippet 41"
for i in range\(10\):  
    start = time\.time\(\)  
...
```text title="week2.md snippet 42"
...
```text title="week2.md snippet 43"
...
```text title="week2.md snippet 48"
