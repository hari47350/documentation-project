...
```python title="teama week10 (snippet 3)"
<a id="approach"></a>## Approach

```
1. __Install MongoDB Database Tools__
```python title="teama week10 (snippet 4)"
...
```python title="teama week10 (snippet 5)"
...
```
2. __Run Backup__
```python title="teama week10 (snippet 6)"
...
```
```text title="week10.md snippet 2"
extracted\_entities: 3 documents  
raw\_documents: 1 document  
users: 1 document
```
3. __Results__
```python title="teama week10 (snippet 7)"
...
```python title="teama week10 (snippet 8)"
...
```python title="teama week10 (snippet 9)"
...
```python title="teama week10 (snippet 10)"
<a id="usage"></a>## Usage
...
\# Example output  
```text title="week10.md snippet 3"
