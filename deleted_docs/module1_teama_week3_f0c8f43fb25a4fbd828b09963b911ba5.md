...
```python title="week3.md snippet 9"
...
```python title="week3.md snippet 11"
...
```python title="week3.md snippet 13"
def get\_db\(\):  
    return client\["mydb"\]  
```
...
```python title="week3.md snippet 19"
...
```python title="week3.md snippet 22"
...
\# Cleanup old backups  
```text title="week3.md snippet 30"
...
```text title="week3.md snippet 31"
...
```text title="week3.md snippet 32"
...
```python title="week3.md snippet 33"
...
NUM\_SEGMENTS = 10000  
```text title="week3.md snippet 37"
...
```text title="week3.md snippet 38"
Purpose: Insert missing segments and benchmark query performance across iterations\.
```

```python title="week3.md snippet 39"
import time  
from datetime import datetime, timezone  
from storage\.mongo\_client import get\_db  
```
  
```text title="week3.md snippet 40"
db = get\_db\(\)  
DOC = db\.raw\_documents\.find\_one\(\)  
DOC\_ID = str\(DOC\['\_id'\]\)  
```
...
NUM\_SEGMENTS = 10000  
```text title="week3.md snippet 41"
...
```text title="week3.md snippet 42"
Purpose: Quick benchmark script to measure query time and run explain plan\.
```

```python title="week3.md snippet 43"
import time  
from datetime import datetime, timezone  
from storage\.mongo\_client import get\_db  
```
  
```text title="week3.md snippet 44"
db = get\_db\(\)  
DOC = db\.raw\_documents\.find\_one\(\)  
DOC\_ID = str\(DOC\['\_id'\]\)  
```
TENANT\_ID = "t0"  
```text title="week3.md snippet 45"
query = \{"tenant\_id": TENANT\_ID, "doc\_id": DOC\_ID\}  
```
  
times = \[\]  
```text title="week3.md snippet 46"
for i in range\(10\):  
    start = time\.time\(\)  
...
```text title="week3.md snippet 47"
...
```text title="week3.md snippet 48"
...
```text title="week3.md snippet 53"
