...
```text title="week16.md snippet 1"
...
```text title="week16.md snippet 2"
Required software and environment:
```

```text title="week16.md snippet 3"
\- Python \(3\.10\+ recommended\)
```

```text title="week16.md snippet 4"
\- Virtual environment \(recommended \.venv\)
```

```text title="week16.md snippet 5"
\- MongoDB \(local or remote\) with access and appropriate user/URI
```

```text title="week16.md snippet 6"
\- MongoDB Database Tools \(mongodump\) for backups
```

```text title="week16.md snippet 7"
\- Python dependencies: pymongo
```

  
```text title="week16.md snippet 8"
...
```python title="week16.md snippet 9"
...
```text title="week16.md snippet 10"
