...
```text title="week1.md snippet 11"
MONGO\_URI = os\.getenv\("MONGO\_URI", "mongodb://localhost:27017/"\)  
client = MongoClient\(MONGO\_URI\)  
```
  
```python title="week1.md snippet 12"
def get\_db\(\):  
    return client\["mydb"\]  
```
  
```text title="week1.md snippet 13"
db = get\_db\(\)  
```
...
```python title="week1.md snippet 18"
...
```text title="week1.md snippet 21"
...
```text title="week1.md snippet 22"
...
```python title="week1.md snippet 31"
...
```text title="week1.md snippet 33"
db = get\_db\(\)  
...
```text title="week1.md snippet 35"
...
```text title="week1.md snippet 39"
db = get\_db\(\)  
DOC = db\.raw\_documents\.find\_one\(\)  
DOC\_ID = str\(DOC\['\_id'\]\)  
```
...
```text title="week1.md snippet 43"
...
```python title="week1.md snippet 47"
...
```python title="week1.md snippet 50"
...
```text title="week1.md snippet 52"
...
```python title="week1.md snippet 56"
...
```text title="week1.md snippet 60"
